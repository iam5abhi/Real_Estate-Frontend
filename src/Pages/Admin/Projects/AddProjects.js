...
const AddProjects = () => {
  const navigate = useNavigate()
    ...
    const AddProjectSubmit = async (event)=>{
      ...
      try {
        const resp = await authFetch.post('/api/admin/project',{PropertId:formData.project_name, 
  ...
  return (
        ...
        <div className="flex min-h-full items-center justify-center py-8 px-4 sm:px-6 lg:px-8 ">
            <div className="w-full max-w-lg space-y-8 shadow-2xl rounded-lg px-5 py-5 bg-white">
              <div>
                <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Add Project</h2>
              </div>
              <form onSubmit={AddProjectSubmit}>
                <div className='mt-3 '>
                 <div className='mb-2'>
                   ...
                   <select id="Status" onChange={OnChangeHandler} name='project_name' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-3" >
                 ...
                 <div className='mb-2'>
                   ...
                   <input type="text" name='property_name' onChange={OnChangeHandler} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 disabled:opacity-75" placeholder='Enter Property Name' />
                 </div>
                 <div className='mb-2'>
                    <h1 className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Property Type <span class="text-red-600">*</span></h1>
                    <input type="radio" name='property_type' onChange={OnChangeHandler} value='residential' id="description" className="bg-orange-50 border border-gray-300 text-orange-600 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500" placeholder='Enter Description' required />
                ...
                <div className='mb-3'>
                        ...
                        <input type="checkbox" value='2bhk' onChange={BHKHandler} className="bg-orange-50 border border-gray-300 text-orange-600 text-sm rounded-sm focus:ring-orange-500 focus:border-orange-500" placeholder='Enter Description' required />
                        <label className="text-sm font-medium text-gray-900 dark:text-white"> 2bhk </label>
                        <input type="checkbox" value='3bhk' onChange={BHKHandler} className="bg-orange-50 border border-gray-300 text-orange-600 text-sm rounded-sm focus:ring-orange-500 focus:border-orange-500" placeholder='Enter Description' required />
                        <label className="text-sm font-medium text-gray-900 dark:text-white"> 3bhk </label>
                        <input type="checkbox" value='4bhk' onChange={BHKHandler} className="bg-orange-50 border border-gray-300 text-orange-600 text-sm rounded-sm focus:ring-orange-500 focus:border-orange-500" placeholder='Enter Description' required />

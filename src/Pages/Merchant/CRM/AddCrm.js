...
const AddCrm = () => {
    ...
    const [formData, setFormData] = useState({name:'', email:'', phoneNumber:'', AlternatePhoneNumber:'', 
        leadOfSource:'', loan:'', buy:'', budget:'', desc:'', status:'',Property:''
    })
    ...
    const FormSubmitHandler = async () => {
        try {
            const resp = await authFetch.post('/api/merchant/merchant-query',{...formData,Property:selectProperty});
                        ...
                        {profileStep.step === 1 ? <>
                            <div className="py-8">
                                <div >
                                    ...
                                    <div className="mb-2">
                                        <label htmlFor="email" className="font-bold mb-1 text-gray-700 block">Lead Source</label>
                                    ...
                                    {!propertyData?null:propertyData.map(datas=>(
                                        <span className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100">
                                            <div className='text-end'>
                                                <input type="checkbox" value={datas._id} onChange={PropertyChangeHandler} className="text-end w-4 h-4 mr-1 text-orange-600 bg-gray-100 border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                                            </div>
                            ...
                            : profileStep.step === 3 ? <>
                                <label htmlFor="email" className="font-bold mb-1 text-gray-700 block mb-3 mt-8">Loan</label>
                                <div className="mb-2 flex">
                                ...
                                <label htmlFor="email" className="font-bold mb-1 text-gray-700 block mb-3">When To Buy</label>
                                <div className="mb-2 flex">
                                ...
                                <div className="mb-2">
                                    <label htmlFor="email" className="font-bold mb-1 text-gray-700 block mb-2">Budget</label>
                                ...
                                : profileStep.step === 4 ? <>
                                    <div className="mb-2 mt-8">
                                        <label htmlFor="email" className="font-bold mb-1 text-gray-700 block mb-2">Notes</label>
                                        <textarea type="text" name='desc' value={formData.desc} onChange={OnChangeHandler} className="w-full px-4 py-2 rounded-lg shadow-sm focus:ring-orange-500 focus:border-orange-500 focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your notes..." />
                                    </div>
                                    <label htmlFor="email" className="font-bold mb-1 text-gray-700 block mb-3 mt-3">Status</label>
                                    <div className="mb-2 flex">

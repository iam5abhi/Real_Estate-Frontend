...
export default function ProjectStatusModal({setOpen,open,id,GetPropertyData}) {
  ...
  const StatuSubmitHandler = async ()=> {
    try {
      const resp = await authFetch.patch(`/api/admin/project-status/${id}`,{propertystatus:status});
